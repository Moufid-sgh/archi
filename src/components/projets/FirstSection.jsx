            ...
            <div className='md:flex items-center justify-between w-full mt-20 md:mt-40'>
                <div className='mb-10 md:mb-0 lg:w-1/2'>
                    <div className='overflow-hidden'>
                        <h1 ref={titleRef} className="text-9xl font-semibold BebasNeue">NOS PROJETS</h1>
                    </div>
                    <div className='overflow-hidden'>
                        <p ref={subtitleRef} className='text-xl pr-28'>Des espaces pensés pour l’usage, guidés par l’émotion et portés par une vision.</p>
                    </div>
                </div>
