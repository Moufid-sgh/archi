    ...
    <div className="border border-gray-200 rounded-lg mb-2 overflow-hidden">
      ...
      >
        <div className="px-6 py-4 bg-white">
          ...
          <p className='text-end italic font-bold text-sm'>{objectif}</p>
        </div>
      </div>
    </div>
  );
...
export default function Accordion() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className='mb-6'>
        <p className='text-2xl text-violet-600 font-bold mb-2'>The Kick-Off</p>
        <p className=''>Penser juste, dès le début.</p>
      </div>
